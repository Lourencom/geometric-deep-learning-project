...
echo "Compare all models with head averaging..."
python main.py --aggregate_heads_fn average --prompt_ids 1 2 4 --output_dir "${BASE_OUTPUT_DIR}/two_shot/average_compare_all_models/" --models "mistral,8b,instruct" "mistral,24b,instruct" "qwen,1.5b,instruct" "qwen,3b,instruct" "qwen,7b,instruct" "llama,1b,instruct" "llama,8b,instruct" "gemma,2b,instruct" "gemma,9b,instruct" "gemma,27b,instruct"


echo "Compare all models with entropy..."
python main.py --aggregate_heads_fn entropy --entropy_alpha 1.0 --prompt_ids 1 2 4 --output_dir "${BASE_OUTPUT_DIR}/two_shot/entropy_compare_all_models/" --models "mistral,8b,instruct" "mistral,24b,instruct" "qwen,1.5b,instruct" "qwen,3b,instruct" "qwen,7b,instruct" "llama,1b,instruct" "llama,8b,instruct" "gemma,2b,instruct" "gemma,9b,instruct" "gemma,27b,instruct"
